...
| 11 | SHANKPIT-460 map creation pipeline — report only, no code | `shankpit460-maps-report.md` | **ready to dispatch** | none — current map system is 142 lines, one hardcoded box layout compiled into the binary, no file format/loader/editor at all |
