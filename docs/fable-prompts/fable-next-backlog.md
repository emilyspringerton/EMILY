...
| 9 | Augment/improve OKEMILY landing page + signup funnel, grounded in golden docs | `okemily-landing-page-augment.md` | **ready to dispatch** | none — but verify mailing-list vault is unlocked (found locked earlier 2026-07-19) before trusting the funnel works; deploy itself needs a human (`sudo rsync` + nginx reload per `OKEMILY/CLAUDE.md`) |
