...
| SHANKPIT460-NORTH | shankpit-460/docs2/NORTHSTAR.md | 2 | 2000 | SHANKPIT-460 esports fork v0 scoping: accounts via VS0 reuse (shankpit_auth.go already built, game server doesn't validate it yet), basic matchmaking as a simplified VS2-lifecycle-shaped queue (not poker mechanics), "skip the backpack problem" formalized as VS2's closed-non-redeemable-economy doctrine, web stats via VS10 doctrine + already-live /api/v1/players endpoints; resolved finding: apps/server/src/main.c has no match/round-boundary concept at all yet |
